...
以下主要说明针对各个函数正常和异常的测试用例及测试结果。
	...
	\end{figure}
		...
		\begin{figure}[htbp]
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/定位元素失败.png}
			\end{minipage}
			\caption{查找元素失败}
			\label{fig1-20}
		\end{figure}
		...
		\begin{figure}[htbp]
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/前驱元素存在.png}
			\end{minipage}
			\caption{查找前驱元素成功}
			\label{fig1-21}
		\end{figure}
		...
		\begin{figure}[htbp]
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/前驱元素不存在.png}
			\end{minipage}
			\caption{查找前驱元素失败}
			\label{fig1-22}
		\end{figure}
		...
		\begin{figure}[htbp]
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/后继元素存在.png}
			\end{minipage}
			\caption{查找后继元素成功}
			\label{fig1-23}
		\end{figure}
		...
		\begin{figure}[htbp]
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/后继元素不存在.png}
			\end{minipage}
			\caption{查找后继元素失败}
			\label{fig1-24}
		\end{figure}
		...
		\begin{figure}[htbp]
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/插入成功.png}
			\end{minipage}
			\caption{插入元素成功}
			\label{fig1-25}
		\end{figure}
		...
		\begin{figure}[htbp]
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/插入失败.png}
			\end{minipage}
			\caption{插入元素失败}
			\label{fig1-26}
		\end{figure}
		...
		\begin{figure}[htbp]
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/删除成功.png}
			\end{minipage}
			\caption{删除元素成功}
			\label{fig1-27}
		\end{figure}
	...
	\begin{figure}[htbp]
		...
		\begin{minipage}{0.7\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{images/删除失败.png}
		\end{minipage}
		\caption{删除元素失败}
		\label{fig1-28}
	\end{figure}
		...
		输入[1,2]，遍历结果如下图：
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/遍历成功.png}
			\end{minipage}
			\caption{遍历线性表成功}
			\label{fig1-29}
		\end{figure}
		...
		\begin{figure}[htbp]
			...
			\begin{minipage}{0.7\linewidth}
				\centering
				\includegraphics[width=0.9\linewidth]{images/翻转成功.png}
				\includegraphics[width=0.9\linewidth]{images/翻转结果.png}
			\end{minipage}
			\caption{翻转线性表成功}
			\label{fig1-30}
		\end{figure}
...
\end{figure}
	...
	\begin{figure}[htbp]
		...
		\begin{minipage}{0.7\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{images/求深度成功.png}
		\end{minipage}
		\caption{二叉树求深度成功}
		\label{fig2-12}
	\end{figure}
	...
	输入二叉树A，查找关键字为9的节点，输出结果如下图：
		...
		\begin{minipage}{0.7\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{images/查找失败.png}
		\end{minipage}
		\caption{查找结点失败}
		\label{fig2-13}
	\end{figure}
	...
	\begin{figure}[htbp]
		...
		\begin{minipage}{0.7\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{images/查找节点成功.png}
		\end{minipage}
		\caption{查找结点成功}
		\label{fig2-14}
	\end{figure}
	...
	\begin{figure}[htbp]
		...
		\begin{minipage}{0.7\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{images/赋值失败.png}
		\end{minipage}
		\caption{结点赋值成功}
		\label{fig2-15}
	\end{figure}
	...
	\begin{figure}[htbp]
		...
		\begin{minipage}{0.7\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{images/赋值成功.png}
		\end{minipage}
		\caption{结点赋值成功}
		\label{fig2-16}
	\end{figure}
	...
	\begin{figure}[htbp]
		...
		\begin{minipage}{0.7\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{images/查找兄弟成功.png}
		\end{minipage}
		\caption{获取兄弟结点成功}
		\label{fig2-17}
	\end{figure}
	...
	输入二叉树A，插入节点8 g到关键字为2节点的右边，输出结果如下图：
		...
		\begin{minipage}{0.7\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{images/插入节点成功.png}
		\end{minipage}
		\caption{插入结点成功}
		\label{fig2-18}
	\end{figure}
	...
	\begin{figure}[htbp]
		...
		\begin{minipage}{0.7\linewidth}
			\centering
			\includegraphics[width=0.9\linewidth]{images/删除节点成功.png}
		\end{minipage}
		\caption{删除结点成功}
		\label{fig2-19}
	\end{figure}
...
\begin{figure}[htbp]
	...
	\begin{minipage}{0.7\linewidth}
		\centering
		\includegraphics[width=0.9\linewidth]{images/多树操作前.png}
		\includegraphics[width=0.9\linewidth]{images/多树切换.png}
		\includegraphics[width=0.9\linewidth]{images/多树操作成功.png}
	\end{minipage}
	\caption{多树管理}
	\label{fig2-29}
\end{figure}
